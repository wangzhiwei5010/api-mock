 ...
 * @author wangzhiwei
 */
@Api(value = "酒店 订单相关", description = "订单相关")
@RestController
@Slf4j
@CrossOrigin
public class OrderController {
    ...
    @RequestMapping(value = "/order/setMock", method = {RequestMethod.POST})
