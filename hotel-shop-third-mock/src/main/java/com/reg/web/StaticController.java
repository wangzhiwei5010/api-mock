 ...
 * @author wangzhiwei
 */
@Api(value = "酒店 基础信息相关", description = "静态数据相关")
@RestController
@Slf4j
@CrossOrigin
public class StaticController {
    ...
    @RequestMapping(value = "/static/{methodName}", method = {RequestMethod.POST})
    ...
    @RequestMapping(value = "/static/setMock", method = {RequestMethod.POST})
